/**
 * This example could be extended to implement optional methods (on the ProxyDevice object) that
 * can improve the accuracy of the initial inter-device timing at the start of sampling:
...
import { kEnableLogging, kStreamNames } from './Teensy_4_NoSync';
...
class DeviceStreamConfiguration implements IDeviceStreamConfiguration {
   ...
   constructor(posFullScaleV = 1, public dataFormat = 0) {
...
export class ProxyDevice implements IProxyDevice {
   ...
   // --- Optional support. Requires a firmware implementation -----
   //
