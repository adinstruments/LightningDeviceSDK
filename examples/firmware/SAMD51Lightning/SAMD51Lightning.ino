...
/* N.B. to upload this firmware to the SAMD51 first double click the board's reset button
   to put it into boot loader mode. Then set the Arduino IDE port to the correct (boot loader)
   port.
*/
